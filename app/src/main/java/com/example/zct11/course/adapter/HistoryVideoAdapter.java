...
public class HistoryVideoAdapter extends RecyclerView.Adapter<HistoryVideoAdapter.videoViewHolder> {
    ...
    public HistoryVideoAdapter(List<History> data, Context context) {
        this.data = data;
    ...
    public videoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new videoViewHolder(inflater.inflate(R.layout.historyvideo_item,null));
    }
    ...
    private void setViewHolder(final videoViewHolder holder, final int position) {
        ...
        ImageLoaderUtils.displaySmallPhoto(context,holder.imageView,data.get(position).getImg());
