...
public class SprogAdapter extends RecyclerView.Adapter<SprogAdapter.MainViewHolder> {

    private List<MainRecommend> data;
    private Context context;
    private LayoutInflater inflater;

    public SprogAdapter(List<MainRecommend> data, Context context) {
        this.data = data;
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MainViewHolder(inflater.inflate(R.layout.layout_newrecommend,null));
    }
